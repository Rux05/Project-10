...
describe("API orders test", () => {
    ...
    it("should display the list of products from the basket", () => {
    ...
    it("should not display the list of products from the basket if not authenticated", () => {
        cy.logout();
        cy.request({
            method: "GET",
            url: `${UrlApi}/orders`, 
    ...
    it("should return a forbidden error when not authorized to view basket products", () => {
